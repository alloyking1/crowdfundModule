...
const types = [
  ...
  ["/cosmonaut.crowdfund.crowdfund.MsgCancelCampaign", MsgCancelCampaign],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgCancelCampaign: (data: MsgCancelCampaign): EncodeObject => ({ typeUrl: "/cosmonaut.crowdfund.crowdfund.MsgCancelCampaign", value: MsgCancelCampaign.fromPartial( data ) }),
