...
const baseMsgClaimToken = { creator: "", id: 0 };
export const MsgClaimToken = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgClaimToken };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseMsgClaimTokenResponse = {};
export const MsgClaimTokenResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgClaimTokenResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
const baseMsgWithdrawPledge = { creator: "", id: 0 };
export const MsgWithdrawPledge = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgWithdrawPledge };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseMsgWithdrawPledgeResponse = {};
...
const baseMsgCancelCampaign = { creator: "", id: 0 };
export const MsgCancelCampaign = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgCancelCampaign };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseMsgCancelCampaignResponse = {};
...
export class MsgClientImpl {
    ...
    ClaimToken(request) {
        ...
        const promise = this.rpc.request("cosmonaut.crowdfund.crowdfund.Msg", "ClaimToken", data);
        return promise.then((data) => MsgClaimTokenResponse.decode(new Reader(data)));
    }
    WithdrawPledge(request) {
        const data = MsgWithdrawPledge.encode(request).finish();
        const promise = this.rpc.request("cosmonaut.crowdfund.crowdfund.Msg", "WithdrawPledge", data);
        return promise.then((data) => MsgWithdrawPledgeResponse.decode(new Reader(data)));
    }
    CancelCampaign(request) {
        const data = MsgCancelCampaign.encode(request).finish();
        const promise = this.rpc.request("cosmonaut.crowdfund.crowdfund.Msg", "CancelCampaign", data);
        return promise.then((data) => MsgCancelCampaignResponse.decode(new Reader(data)));
    }
}
var globalThis = (() => {
